...
export function ProgramMetrics() {
  ...
  return (
    <div className="grid grid-cols-1 divide-neutral-200 rounded border border-neutral-100 max-md:divide-y md:grid-cols-4 md:divide-x">
      <Stat
        icon={Users}
        label="Partners"
        tab="partners"
  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        ...
        {isLoading ? (
          <div className="h-7 w-24 animate-pulse rounded bg-neutral-200 md:mt-2.5 md:h-8 lg:h-11" />
        ) : (
