            ...
            <>
              ...
              {canUpdateFolder && !isLoadingPermissions && (
                <div className="relative flex items-center">
                  ...
                  <select
                    className="appearance-none rounded border border-neutral-100 bg-white pl-10 pr-8 text-sm text-neutral-900 focus:border-neutral-300 focus:ring-transparent"
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-x-3">
        <select
          className={cn(
            "rounded border border-neutral-100 text-xs text-neutral-900 focus:border-neutral-600 focus:ring-neutral-600",
            {
