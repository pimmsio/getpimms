...
export function Personalization() {
  return (
    <div
      ...
      tabIndex={-1}
    >
      <div className="mx-3.5 flex cursor-default flex-col gap-3 rounded border border-neutral-100 bg-white p-5 shadow-[0_20px_20px_0_#00000017]">
        ...
        <div className="flex flex-col gap-2.5">
          {OPTIONS.map(({ label, icon: Icon, checked }) => (
            <div
              key={label}
              className="flex items-center justify-between gap-2 rounded border border-neutral-100 p-2.5"
            >
