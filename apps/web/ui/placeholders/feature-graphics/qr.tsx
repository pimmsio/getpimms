...
export function QR() {
  ...
  return (
    <div className="size-full [mask-image:linear-gradient(black_70%,transparent)]">
      <div
        className="mx-3.5 flex origin-top scale-95 cursor-default flex-col gap-6 rounded border border-neutral-100 bg-white p-4 shadow-[0_20px_20px_0_#00000017]"
        aria-hidden
      >
        ...
        <div>
          ...
          <div className="relative mt-2 flex h-40 items-center justify-center overflow-hidden rounded border border-neutral-300">
            {/* <ClientOnly>
              {!isMobile && (
