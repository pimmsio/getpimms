    ...
    >
      <div className="relative size-full">
        ...
        {showCompleted && !cardCount && (
          ...
          >
            <div className="animate-fade-in absolute inset-0 rounded border border-neutral-200 [animation-delay:2.3s] [animation-direction:reverse] [animation-duration:0.2s]" />
...
function NewsCard({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative select-none gap-2 rounded border border-neutral-100 bg-white p-3 text-[0.8125rem]",
    ...
    >
      <div className={cn(hideContent && "invisible")}>
        ...
        <div className="relative mt-3 aspect-[16/9] w-full shrink-0 overflow-hidden rounded border border-neutral-100 bg-neutral-100">
          {image && (
            <Image
              src={image}
              alt=""
