...
export function ProgramInviteCard({
  ...
  return (
    <div className="hover:drop-shadow-card-hover relative flex flex-col items-center justify-center gap-2 rounded border border-neutral-300 bg-neutral-50 p-4 transition-[filter]">
      <StatusBadge
        variant="new"
        icon={null}
