    ...
    <div>
      ...
      <div className="mt-5 grid grid-cols-1 gap-3">
        {block.data.items.map((file, idx) => (
          <a
            key={idx}
            className="group flex items-center justify-between gap-4 rounded border border-neutral-100 bg-white p-3 transition-colors duration-75 hover:bg-neutral-50 active:bg-neutral-100"
            href={file.url}
