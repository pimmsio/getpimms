...
export default function OAuthAppCard(oAuthApp: OAuthAppProps) {
  ...
  return (
    <Link
      ...
      className="hover:drop-shadow-card-hover relative rounded border border-neutral-100 bg-white px-5 py-4 transition-[filter]"
    >
      <div className="flex items-center gap-x-3">
        <div className="rounded border border-neutral-100 bg-gradient-to-t from-neutral-100 p-2.5">
          {oAuthApp.logo ? (
            <BlurImage
              src={oAuthApp.logo}
