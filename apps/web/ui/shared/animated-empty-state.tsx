...
export function AnimatedEmptyState({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center gap-6 rounded border border-neutral-200 px-4 py-10 mx-3 lg:mx-10 md:min-h-[500px]",
        className,
      )}
    >
...
function Card({ children }: PropsWithChildren) {
  return (
    <div className="mt-4 flex items-center gap-3 rounded border border-neutral-100 bg-white p-4 shadow-[0_4px_12px_0_#0000000D]">
      {children}
    </div>
  );
}
