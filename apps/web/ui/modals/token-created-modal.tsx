    ...
    >
      ...
      <div className="flex flex-col space-y-4 bg-neutral-50 px-4 py-8 sm:px-6">
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center justify-between rounded border border-neutral-100 bg-white p-2">
            ...
            <button
              ...
              type="button"
              className="text-neutral-90 flex h-7 items-center gap-2 rounded border border-neutral-100 bg-white px-2 py-1 text-xs font-medium hover:bg-neutral-50"
            >
              {copied ? (
