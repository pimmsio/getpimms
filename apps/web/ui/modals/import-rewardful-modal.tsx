    ...
    <form onSubmit={onSubmit} className="flex flex-col space-y-4">
      <div>
        ...
        <input
          ...
          className="mt-1 block w-full rounded border border-neutral-100 px-3 py-2 placeholder-neutral-400 focus:border-neutral-500 focus:outline-none focus:ring-0 sm:text-sm"
          required
        />
    ...
    <form onSubmit={onSubmit} className="flex flex-col space-y-6">
      <div>
        ...
        <select
          ...
          className="mt-1 block w-full rounded border border-neutral-100 bg-white px-3 py-2 text-sm text-neutral-900 placeholder-neutral-400 focus:border-neutral-500 focus:outline-none focus:ring-0"
        >
      ...
      {selectedCampaign && (
        <dl className="grid grid-cols-2 gap-3 rounded border border-neutral-100 bg-white p-4 text-xs">
          <div>
