...
export default function WebhookCard(webhook: WebhookProps) {
  ...
  return (
    <Link
      ...
      className="hover:drop-shadow-card-hover relative rounded border border-neutral-200 bg-white px-5 py-4 transition-[filter]"
    >
      <div className="flex items-center gap-x-3">
        <div className="flex-shrink-0 rounded border border-neutral-200 bg-gradient-to-t from-neutral-100 p-2.5">
