...
export default function WebhookCard(webhook: WebhookProps) {
  ...
  return (
    <Link
      ...
      className="relative rounded border border-neutral-100 bg-white px-5 py-4 transition-colors hover:bg-neutral-50/40"
    >
      <div className="flex items-center gap-x-3">
        <div className="flex-shrink-0 rounded border border-neutral-100 bg-neutral-100/60 p-2.5">
