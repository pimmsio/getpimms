  ...
  return (
    <form className="mt-4 flex items-end gap-2" onSubmit={onSubmit}>
      <div className="w-full rounded border border-neutral-100 bg-white">
        ...
        <div className="p-4">
          ...
          {plan === "free" || plan === "starter" || plan === "pro" ? (
            ...
            <div className="relative mt-4 rounded shadow-sm">
              <input
                className="w-full rounded border-neutral-300 text-neutral-900 placeholder-neutral-400 focus:border-neutral-500 focus:outline-none focus:ring-0 sm:text-sm"
        ...
        <div className="flex items-center justify-end rounded-b border-t-[6px] border-neutral-100 bg-neutral-50 px-4 py-3">
