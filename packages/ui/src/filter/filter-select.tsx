    ...
    <Command.Input
      ...
      onKeyDown={(e) => {
        ...
        if (e.key === "Enter" && isEmpty) {
          // Call the provided emptySubmit handler without forwarding it to DOM
          (props as { emptySubmit?: (e: React.KeyboardEvent<HTMLInputElement>) => void }).emptySubmit?.(e);
        }
      }}
      autoCapitalize="none"
    />
