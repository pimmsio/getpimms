      ...
      <div>
        <div className="relative flex">
          <input
            ...
            className={cn(
              "w-full max-w-md rounded-lg border border-neutral-200 text-black placeholder-neutral-400 focus:border-neutral-500 focus:outline-none focus:ring-0 sm:text-sm",
              props.error &&
