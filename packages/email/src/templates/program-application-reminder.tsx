  ...
  return (
    <Html>
      ...
      <Preview>
        ...
        create your PiMMs Partner account to complete your application.
      </Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded-3xl border-[6px] border-solid border-neutral-100 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-neutral-600">
              ...
              saved, but you still need to create your PiMMs Partners account to
              complete your application.
              <br />
              <br />
              Once you create your PiMMs Partners account, your application will
            ...
            <Section className="mt-8 text-center">
              <Link
                href={`https://partners.pimms.io/${program.slug}/register`}
